...
namespace NanoDNA.ProcessRunner.Tests
{
    ...
    internal class BaseUnitTest
    {
        ...
        /// </summary>
        protected static readonly string DEFAULT_APPLICATION_COMMAND = OperatingSystem.IsWindows() ? "/c echo Hello" : "-c echo Hello World";

        /// <summary>
        /// The Default Application Command to run in the tests that will fail. Dependent on OS
        /// </summary>
        protected static readonly string DEFAULT_APPLICATION_FAIL_COMMAND = OperatingSystem.IsWindows() ? "/c echoe Hello" : "-c echoe Hello World";
